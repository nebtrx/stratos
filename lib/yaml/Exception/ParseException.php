...
class ParseException extends \RuntimeException implements ExceptionInterface
{
     ...
     * @param StratoException $previous   The previous exception
     */
    public function __construct($message, $parsedLine = -1, $snippet = null, $parsedFile = null, StratoException $previous = null)
    {
